...
export default function LevelOne() {
  ...
  const [doorPosition] = useState(new THREE.Vector3(2, 1, -30)); // Door positioned further away
...
function LevelOneLogic({
  ...
  return (
    <Physics gravity={[0, -9.8, 0]} timeStep="1/60">
      ...
      <Door position={doorPosition} scale={[5, 5, 5]} rotation={[0, Math.PI / 2, 0]} action={doorAction}/>
